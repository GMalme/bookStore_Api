...
import com.gmalme.bookstore.dtos.CategoriaDTO;
...
public class CategoriaService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new com.gmalme.bookstore.service.exceptions.DataIntegrityViolationException(
					"Categoria não pode ser deletada! Ainda possui livros associados");
		}
